<div class="card-group mb-4">
    ...
    <div class="text-value-lg">{{$questions->total()}}</div><small class="text-muted text-uppercase font-weight-bold">{{__('Questions')}}</small>
    <div class="progress progress-xs mt-3 mb-0">
    ...
    <div class="card-body">
    <div class="text-muted text-right mb-4">
        <i class="c-icon c-icon-2xl fas fa-calendar-alt"></i>
    </div>
    <div class="text-value-lg">{{$exam->start_date->toDayDateTimeString()}}</div><small class="text-muted text-uppercase font-weight-bold">{{__('Start Date')}}</small>
    <div class="progress progress-xs mt-3 mb-0">
